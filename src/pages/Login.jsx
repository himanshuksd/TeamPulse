  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (data.access_token) {
        // ✅ FIX: your auth.js saves token as "token", invite check uses pending_invite
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            ...
            <span className="font-extrabold text-[15px] tracking-tight">Team<span className="text-blue-600">Pulse</span></span>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500">
              ...
              <Link to="/register" className="text-blue-600 font-semibold hover:text-blue-700 transition-colors">Sign up free</Link>
            </p>
          </div>
