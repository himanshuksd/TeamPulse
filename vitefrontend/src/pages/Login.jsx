...
//             <Sparkles size={10} /> AI-powered team collaboration
//           </div>
...
//             </button>
//           </div>
//           <p className="text-center text-xs text-gray-400 mt-6">By continuing, you agree to our <a href="#" className="underline">Terms</a> and <a href="#" className="underline">Privacy Policy</a>.</p>
//         </div>
//       </div>
//     </div>
//   );
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-4xl font-extrabold text-white leading-tight mb-4 tracking-tight">
            Welcome back. Continue managing your team efficiently.
          </h2>
          <p className="text-blue-100 text-sm leading-relaxed max-w-xs">
            Monitor tasks, detect risks early, and improve team productivity with AI insights.
          </p>
          <div className="grid grid-cols-3 gap-4 mt-10">
            {[
              { value: "AI", label: "Insights" },
