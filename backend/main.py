...
def ai_summary(payload: dict, current_user: User = Depends(get_current_user)):
    api_key = "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"
...
def root():
    return {
        "status": "TeamPulse backend running",
        "groq_key_set": bool(os.getenv("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"))
    }